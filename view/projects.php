...
<!------------------------------------------------------------BACKGROUND ENDS---------------------------------------------------------->
    <section id="nav">
        <div class="container">
            ...
            <div class="item-2 item"style="cursor:pointer;" onclick="document.location='../view/currentProject.php'"><h1><a href="../view/currentProject.php">Current Projects</a></h1></div>
        </div>
    </section>
