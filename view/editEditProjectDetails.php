...
include("../controller/editProjectDetails.php"); 
        ...
        <div class="operation">
                ...
                <div class="projects">
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <input type="text" name="currentProject">
                            <label for="completedProject">Completed Project</label>
                            <input type="text" name="completedProject">
                            <label for="awardWon">Award Won</label>
                            <input type="text" name="awardWon">
                            <button type="submit" value="submit" name="submit">Edit Details</button>
                        </form>
                </div>
        </div>
    </section>
