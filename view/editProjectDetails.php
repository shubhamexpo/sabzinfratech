        ...
        <div class="operation">
                ...
                <div class="projectDetails">
                    <div class="item">
                        ...
                        <div class="projectName"><h1>On Going Project</h1></div>
                        <div class="projectName"><h1>Completed Project</h1></div>
                        <div class="projectName"><h1>Award Won</h1></div>
                        <div class="edit"style="background:transparent !important;"><h1>Edit</h1></div>
                    </div>
                </div>
                <?php
                $q = "select * from projectDetails";
                    ...
                    ?>
                        <div class="projectDetails">
                            <div class="item">
                                ...
                                <div class="projectName"><h1><?php echo $res['currentProject']?></h1></div>
                                <div class="projectName"><h1><?php echo $res['completedProject']?></h1></div>
                                <div class="projectName"><h1><?php echo $res['awardWon']?></h1></div>
                                <div class="edit"><h1><a style="text-decoration: none;color: #fff !important;"href="../view/editEditProjectDetails.php?sno=<?php echo $res['sno'];?>">Edit</a></h1></div>
                             </div>
                        </div>
